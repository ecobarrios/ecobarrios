      ...
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-transparent opacity-95">
        <div className="flex justify-start items-center z-50 h-full  max-w-[1400px] m-auto">
          <div className="flex flex-col">
            <h1 className="text-7xl font-light text-slate-50">El Programa </h1>
            <h1 className="text-7xl font-extrabold text-slate-50">Ecobarrios Santiago</h1>

            <div className="mt-3 flex flex-col justify-start w-[500px]">

            <p className="text-slate-50 text-justify font-light text-[19px]">Es un programa hecho por <span className="font-bold">El Gobierno 
            ...
            <p className=" text-slate-50 text-justify font-light text-[19px]">Es un llamado a la acción para transformar nuestros espacios en comunidades
