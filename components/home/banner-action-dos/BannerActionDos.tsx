...
function BannerActionDos() {
  return (
    <div className="flex flex-col bg-secondary-cream space-y-10 pb-10">
      ...
      <div className="text-primary-mora text-center md:space-y-4">
        <p className="text-1xl md:text-5xl font-bold">
          Súmate al Programa Ecobarrios Santiago{" "}
        </p>
        <p className="text-[13px] md:text-2xl">y construyamos juntos un futuro más verde</p>
      </div>
    </div>
  );
}
